...
export const SESSIONS = {
  '1': {
    ...
    improvements: [
      { label: 'Filler words', meta: '14 fewer', before: 'Attempt 1: 22', after: 'Latest: 8' },
      { label: 'Speaking pace (WPM)', meta: '8 WPM slower', before: 'Attempt 1: 127', after: 'Latest: 119' },
      {
  ...
  '2': {
    ...
    improvements: [
      { label: 'Filler words', meta: '4 fewer', before: 'Attempt 1: 12', after: 'Latest: 8' },
      { label: 'Speaking pace (WPM)', meta: '3 WPM slower', before: 'Attempt 1: 133', after: 'Latest: 130' },
      { label: 'Timing vs Target (6:00)', meta: 'Closer to target', before: 'Attempt 1: 6:40 (+40s)', after: 'Latest: 6:15 (+15s)' },
    ],
    previousAttempts: [
